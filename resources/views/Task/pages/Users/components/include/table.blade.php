<div class="col-md-12 col-lg-12 col-xl-12">
    <div class="card">
        <div class="card-header">
            <h4 class="card-title" style="margin-right: 22px; display: inline-block">المستخدمين</h4>
               ...
               <div class="row">
                   ...
                   <div class="col-6">
                       <button type="button" class="btn btn-icon btn-outline-danger mr-1 mb-1" id="multi_delete"
                               data-route="{{ route('task.user.multi_delete') }}" style="float: left;display: none">
